...
//    public List<CheckPointsMstDataDto> getCheckPointsMstDetails(String id) {
//        List<CheckPointsMstDataDto> result = new ArrayList<>();
//        Map<String, Object> params = new HashMap<>();
//        StringBuilder SQL = new StringBuilder();
//        SQL.append("SELECT *                                                     \n");
//        SQL.append("from                                                         \n");
//        SQL.append("    mst_project_details                                      \n");
//        SQL.append("where                                                        \n");
//        params.put("project_id", id);
//        SQL.append("project_id =:project_id                                          \n");
//        return namedParameterJdbcTemplate.query(SQL.toString(), params, new ResultSetExtractor<List<CheckPointsMstDataDto>>() {
//
//            @Nullable
//            @Override
//            public List<CheckPointsMstDataDto> extractData(ResultSet rs) throws SQLException, DataAccessException {
//                while (rs.next()) {
//                    CheckPointsMstDataDto checkPointsMstData = new CheckPointsMstDataDto();
//                    checkPointsMstData.setMst_quoted_effort(rs.getFloat("mst_quoted_effort"));
//                    String res = new BigDecimal(rs.getFloat("mst_quatationvalue_actual_shared")).toPlainString();
//                    String res1 = new BigDecimal(rs.getFloat("mst_quatationvalue_calulated")).toPlainString();
//
//                    checkPointsMstData.setMst_quatation_value_calulated(res1);
//                    checkPointsMstData.setMst_quatation_value_actual_shared(res);
//                    checkPointsMstData.setMst_total_effort_spent(rs.getFloat("mst_total_effort_spent"));
//                    checkPointsMstData.setMst_standard_man_day_rate(rs.getFloat("mst_standard_man_day_rate"));
//                    checkPointsMstData.setMst_quoted_man_day_rate(rs.getFloat("mst_quoted_man_day_rate"));
//                    result.add(checkPointsMstData);
//                }
//                return result;
//            }
//        });
